  ...
  function handleReturn() {
    ...
    if (createIssue && returnNotes.trim()) {
      ...
      addIssue({
        ...
        source: 'module',
        trade: 'maintenance',
        // The whole point of asset_id: this is work against a *thing*, so cost and days-out roll
        // up to the vehicle rather than being buried in a title someone has to read.
        assetId: asset.id,
        vendorId: null,
        scheduleId: null,
