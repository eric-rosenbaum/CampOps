        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-[12.5px] text-ink-soft leading-relaxed mt-1 max-w-2xl">
              A housekeeping report should land on the housekeeping lead without an admin touching
              it. Anything filed against a trade with no default here waits in the unassigned pile
              until somebody notices — which is how a maintenance system quietly stops being used.
            </p>
