      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[12px] text-ink-faint whitespace-nowrap">{stockUnit}</span>
            </div>
          </div>
          <div>
        ...
        <div className="rounded-card border border-border bg-cream-dark/30 px-4 py-3 space-y-3">
          <div className="flex items-center justify-between">
            ...
            {packRows.length > 1 && <span className="text-[10px] uppercase tracking-widest text-ink-faint">★ = order default</span>}
          </div>
          {packRows.length === 0 && (
            ...
            <div key={r.key} className="rounded-btn border border-border bg-white px-3 py-2.5 space-y-2">
              <div className="flex items-center gap-2">
                <button type="button" onClick={() => setDefaultRow(r.key)} title="Make default vendor"
                  className={`text-[15px] leading-none ${r.isDefault ? 'text-amber-text' : 'text-forest/25 hover:text-ink-soft'}`}>
                  {r.isDefault ? '★' : '☆'}
                </button>
              ...
              <div className="flex items-center gap-2 text-[12px] text-ink flex-wrap">
                <span>1</span>
        ...
        {!existing && (
          <p className="text-[11px] text-ink-faint flex items-center gap-1 pt-0.5">
