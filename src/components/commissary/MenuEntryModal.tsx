      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {entryType === 'recipe' && (
          <div>
            ...
            {recipes.length === 0 && (
              <p className="text-[11px] text-forest/45 mt-1.5">No recipes yet — add one on the Recipe guide tab.</p>
            )}
          </div>
        )}
        ...
        {entryType === 'item' && (
          <div className="space-y-3">
            <div>
              ...
              <p className="text-[11px] text-forest/45 mt-1.5 leading-relaxed">
