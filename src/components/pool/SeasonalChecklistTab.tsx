...
export function SeasonalChecklistTab() {
  ...
  return (
    <div>
      ...
      {/* The pool's own seasonal tasks. This used to also splice in Pre/Post Camp tasks tagged
          `pool`; that module is gone, and the pool has kept its own list all along. */}
