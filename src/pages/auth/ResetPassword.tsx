    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-stone-50 p-4 sm:p-6">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-xl border border-stone-200 shadow-sm p-8">
          {phase === 'checking' && <p className="text-[13px] text-forest/55 text-center py-4">Verifying your reset link…</p>}

          {phase === 'invalid' && (
            <div className="text-center">
              <h1 className="text-[18px] font-semibold text-forest mb-2">This reset link isn’t valid</h1>
              <p className="text-[13px] text-forest/60 leading-relaxed mb-5">It may have expired or already been used. Request a new one and try again.</p>
          ...
          {phase === 'done' && (
            <div className="text-center">
              ...
              <p className="text-[13px] text-forest/60">Signing you in…</p>
            </div>
          )}
          ...
          {phase === 'ready' && (
            <>
              ...
              <p className="text-[13px] text-forest/55 mb-5">Choose a new password for your account.</p>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-[12px] font-medium text-forest/70 mb-1.5">New password</label>
